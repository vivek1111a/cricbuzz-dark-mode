...
const App: React.FC<{}> = () => {
  ...
  const feedbackFormUrl = "https://forms.gle/6QXCQiKpMFfBG6maA";
  const websiteUrl = "https://vivekwadate.com";
    ...
    <div className={`popup_body ${state.darkModeEnabled ? "dark" : ""}`}>
      ...
      <div className="popup_footer">
        <a
          ...
          onClick={(e) => {
            e.preventDefault();
            handleLinkClick(feedbackFormUrl);
          }}
